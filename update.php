...
if (isset($_SESSION['key'])) {
    if (isset($_GET['fdid']) && $_SESSION['key'] == 'sunny7785068889') {
        $id = $_GET['fdid'];
...
// Delete user
if (isset($_SESSION['key'])) {
    if (isset($_GET['demail']) && $_SESSION['key'] == 'sunny7785068889') {
        $demail = $_GET['demail'];
...
// Add quiz
if (isset($_SESSION['key'])) {
    if (isset($_GET['q']) && $_GET['q'] == 'addquiz' && $_SESSION['key'] == 'sunny7785068889') {
...
// Add question
if (isset($_SESSION['key'])) {
    if (isset($_GET['q']) && $_GET['q'] == 'addqns' && $_SESSION['key'] == 'sunny7785068889') {
        $n = $_GET['n'];
        $eid = $_GET['eid'];
        $ch = $_GET['ch'];
